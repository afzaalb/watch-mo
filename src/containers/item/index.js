...
import TopCastMember from "../../components/item/TopCastMember";
import FullCast from "../../components/item/details/FullCast";
import FullCastMember from "../../components/item/details/FullCastMember";
import Recommendations from "../../components/item/details/Recommendations";
import EachRecommendation from "../../components/item/details/EachRecommendation";
import ExtraDetails from "../../components/item/details/ExtraDetails";
  ...
  render() {
    ...
    if (response.casts) {
      ...
      allWriters = writerList.map((crew, index) => {
        return (
          <Link
            to={`/people/` + crew.id + `/${kebabCase(crew.name)}`}
            key={crew.credit_id}
          >
            <span
              key={crew.credit_id}
