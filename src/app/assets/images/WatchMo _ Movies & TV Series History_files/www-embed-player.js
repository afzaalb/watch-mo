...
function Fa(a){if(!Ha.test(a))return a;-1!=a.indexOf("&")&&(a=a.replace(Ia,"&amp;"));-1!=a.indexOf("<")&&(a=a.replace(Ja,"&lt;"));-1!=a.indexOf(">")&&(a=a.replace(Ka,"&gt;"));-1!=a.indexOf('"')&&(a=a.replace(La,"&quot;"));-1!=a.indexOf("'")&&(a=a.replace(Ma,"&#39;"));-1!=a.indexOf("\x00")&&(a=a.replace(Na,"&#0;"));return a}
var Ia=/&/g,Ja=/</g,Ka=/>/g,La=/"/g,Ma=/'/g,Na=/\x00/g,Ha=/[\x00&<>"']/;function Oa(a){for(var b=0,c=0;c<a.length;++c)b=31*b+a.charCodeAt(c)>>>0;return b}
;var Pa;a:{var Qa=p.navigator;if(Qa){var Ra=Qa.userAgent;if(Ra){Pa=Ra;break a}}Pa=""}function D(a){return-1!=Pa.indexOf(a)}
...
function Hb(a,b){Sa(b,function(b,d){b&&b.K&&(b=b.I());"style"==d?a.style.cssText=b:"class"==d?a.className=b:"for"==d?a.htmlFor=b:Ib.hasOwnProperty(d)?a.setAttribute(Ib[d],b):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,b):a[d]=b})}
...
function Jb(a,b,c){var d=arguments,e=document,f=String(d[0]),g=d[1];if(!pb&&g&&(g.name||g.type)){f=["<",f];g.name&&f.push(' name="',Fa(g.name),'"');if(g.type){f.push(' type="',Fa(g.type),'"');var h={};bb(h,g);delete h.type;g=h}f.push(">");f=f.join("")}f=e.createElement(f);g&&(r(g)?f.className=g:w(g)?f.className=g.join(" "):Hb(f,g));2<d.length&&Kb(e,f,d);return f}
...
l.get=function(a,b){for(var c=a+"=",d=(this.b.cookie||"").split(";"),e=0,f;e<d.length;e++){f=Ea(d[e]);if(0==f.lastIndexOf(c,0))return f.substr(c.length);if(f==a)return""}return b};
l.remove=function(a,b,c){var d=q(this.get(a));this.set(a,"",0,b,c);return d};
l.isEmpty=function(){return!this.b.cookie};
l.clear=function(){for(var a=(this.b.cookie||"").split(";"),b=[],c=[],d,e,f=0;f<a.length;f++)e=Ea(a[f]),d=e.indexOf("="),-1==d?(b.push(""),c.push(e)):(b.push(e.substring(0,d)),c.push(e.substring(d+1)));for(a=b.length-1;0<=a;a--)this.remove(b[a])};
...
l=Ec.prototype;l.equals=function(a,b){if(this===a)return!0;if(this.f!=a.f)return!1;var c=b||Hc;Gc(this);for(var d,e=0;d=this.b[e];e++)if(!c(this.get(d),a.get(d)))return!1;return!0};
function Hc(a,b){return a===b}
l.isEmpty=function(){return 0==this.f};
l.clear=function(){this.h={};this.g=this.f=this.b.length=0};
l.remove=function(a){return Object.prototype.hasOwnProperty.call(this.h,a)?(delete this.h[a],this.f--,this.g++,this.b.length>2*this.f&&Gc(this),!0):!1};
...
l.forEach=function(a,b){for(var c=Fc(this),d=0;d<c.length;d++){var e=c[d],f=this.get(e);a.call(b,f,e,this)}};
l.F=function(a){Gc(this);var b=0,c=this.g,d=this,e=new Ac;e.next=function(){if(c!=d.g)throw Error("The map has changed since the iterator was created");if(b>=d.b.length)throw zc;var e=d.b[b++];return a?e:d.h[e]};
...
l.L=function(a){var b=this.b[a];if(b){var c=this.f[b];0!=this.i?(this.g.push(a),this.b[a+1]=ma):(c&&Ba(c,a),delete this.b[a],delete this.b[a+1],delete this.b[a+2])}return!!b};
...
l.m=function(){I.u.m.call(this);this.clear();this.g.length=0};function nd(a){this.b=a}
...
A(vd,ud);l=vd.prototype;l.isAvailable=function(){if(!this.b)return!1;try{return this.b.setItem("__sak","1"),this.b.removeItem("__sak"),!0}catch(a){return!1}};
...
l.F=function(a){var b=0,c=this.b,d=new Ac;d.next=function(){if(b>=c.length)throw zc;var d=c.key(b++);if(a)return d;d=c.getItem(d);if(!r(d))throw"Storage mechanism: Invalid value was encountered";return d};
return d};
l.clear=function(){this.b.clear()};
l.key=function(a){return this.b.key(a)};function wd(){var a=null;try{a=window.localStorage||null}catch(b){}this.b=a}
...
l=yd.prototype;l.isAvailable=function(){return!!this.b};
l.set=function(a,b){this.b.setAttribute(Bd(a),b);Cd(this)};
l.get=function(a){a=this.b.getAttribute(Bd(a));if(!r(a)&&null!==a)throw"Storage mechanism: Invalid value was encountered";return a};
l.remove=function(a){this.b.removeAttribute(Bd(a));Cd(this)};
l.F=function(a){var b=0,c=this.b.XMLDocument.documentElement.attributes,d=new Ac;d.next=function(){if(b>=c.length)throw zc;var d=c[b++];if(a)return decodeURIComponent(d.nodeName.replace(/\./g,"%")).substr(1);d=d.nodeValue;if(!r(d))throw"Storage mechanism: Invalid value was encountered";return d};
return d};
l.clear=function(){for(var a=this.b.XMLDocument.documentElement,b=a.attributes.length;0<b;b--)a.removeAttribute(a.attributes[b-1].nodeName);Cd(this)};
...
b=Nb(b);Db(c,b);try{(a.head||a.body||a.documentElement).appendChild(c),N.Pa()}catch(h){}},c=L[1];
...
function Vd(a){p.processGoogleToken=p.processGoogleToken||function(a,c){var b=a,e=c;b=void 0===b?{}:b;e=void 0===e?0:e;var f=b.newToken||"",g="NT"==f,h=parseInt(b.freshLifetimeSecs||"",10),k=parseInt(b.validLifetimeSecs||"",10);g&&!k&&(k=3600);var m=b["1p_jar"]||"";b=b.pucrd||"";Sd();1==e?N.Ra():N.Qa();if(!f&&N.shouldRetry())Pd(".google.com")&&(L[1]=".google.com"),N.ja();else{var u=Qd.googleToken=Qd.googleToken||{},M=0==e&&f&&r(f)&&!g&&la(h)&&0<h&&la(k)&&0<k&&r(m);g=g&&!N.da()&&(!(K[3]>=z())||"NT"==
K[1]);var Z=!(K[3]>=z())&&0!=e;if(M||g||Z)g=z(),h=g+1E3*h,k=g+1E3*k,1E-5>Math.random()&&(g="https://pagead2.googlesyndication.com/pagead/gen_204?id=imerr&err="+e,p.google_image_requests||(p.google_image_requests=[]),Z=p.document.createElement("img"),Z.src=g,p.google_image_requests.push(Z)),u[5]=e,u[1]=f,u[2]=h,u[3]=k,u[4]=m,u[6]=b,Sd();if(M||!N.da()){e=N.na();for(f=0;f<e.length;f++)N.la(e[f]);e.length=0}}};
Ud(a)}
...
function Ne(a,b){var c=b.format||"JSON";a=Le(a,b);var d=Me(a,b),e=!1,f,g=Oe(a,function(a){if(!e){e=!0;f&&ee(f);var d=Fe(a),g=null;if(d||400<=a.status&&500>a.status)g=Pe(c,a,b.gb);if(d)a:if(a&&204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(g&&g.return_code,10);break a;case "RAW":d=!0;break a}d=!!g}g=g||{};var h=b.context||p;d?b.A&&b.A.call(h,a,g):b.onError&&b.onError.call(h,a,g);b.ia&&b.ia.call(h,a,g)}},b.method,d,b.headers,b.responseType,b.withCredentials);
b.M&&0<b.timeout&&(f=U(function(){e||(e=!0,g.abort(),ee(f),b.M.call(b.context||p,g))},b.timeout));
return g}
function Le(a,b){b.Ea&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=Q("XSRF_FIELD_NAME",void 0),d=b.bb;if(d){d[c]&&delete d[c];d=d||{};var e=a.split("#",2);c=e[0];e=1<e.length?"#"+e[1]:"";var f=c.split("?",2);c=f[0];f=Ge(f[1]||"");for(var g in d)f[g]=d[g];a=Kd(c,f)+e}return a}
function Me(a,b){var c=Q("XSRF_FIELD_NAME",void 0),d=Q("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.B,g=Yd("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.hb||Hd(J(a)[3]||null)&&!b.withCredentials&&Hd(J(a)[3]||null)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.B&&b.B[g]||(f||(f={}),f[c]=d);f&&r(e)&&(e=Ge(e),bb(e,f),e=b.qa&&"JSON"==b.qa?JSON.stringify(e):Jd(e));f=e||f&&!Ya(f);!Ie&&f&&"POST"!=b.method&&(Ie=!0,R(Error("AJAX request with postData should use POST")));
return e}
...
function Oe(a,b,c,d,e,f,g){function h(){4==(k&&"readyState"in k?k.readyState:0)&&b&&$d(b)(k)}
c=void 0===c?"GET":c;d=void 0===d?"":d;var k=Ee();if(!k)return null;"onloadend"in k?k.addEventListener("loadend",h,!1):k.onreadystatechange=h;k.open(c,a,!0);f&&(k.responseType=f);g&&(k.withCredentials=!0);c="POST"==c&&(void 0===window.FormData||!(d instanceof FormData));if(e=Je(a,e))for(var m in e)k.setRequestHeader(m,e[m]),"content-type"==m.toLowerCase()&&(c=!1);c&&k.setRequestHeader("Content-Type","application/x-www-form-urlencoded");k.send(d);return k}
;var Ue={},Ve=0;
function We(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=Pa,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a instanceof E||(a=a.K?a.I():String(a),vb.test(a)||(a="about:invalid#zClosurez"),a=xb(a)),b=ub(a),"about:invalid#zClosurez"===b?a="":(b instanceof yb?a=b:(a=null,b.fa&&(a=b.aa()),b=Fa(b.K?b.I():String(b)),a=Ab(b,a)),a=encodeURIComponent(String(Ic(a instanceof yb&&a.constructor===yb&&a.wa===zb?a.ea:"type_error:SafeHtml")))),/^[\s\xa0]*$/.test(a)||(a=Jb("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+
...
c.src=a}
;var Ye={},Ze=0;
function $e(a,b,c,d,e,f){f=f||{};f.name=c||Q("INNERTUBE_CONTEXT_CLIENT_NAME",1);f.version=d||Q("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);b=void 0===b?"ERROR":b;e=void 0===e?!1:e;e=window&&window.yterr||(void 0===e?!1:e)||!1;if(a&&e&&!(5<=Ze)){e=a.stacktrace;c=a.columnNumber;d=v("window.location.href");if(r(a))a={message:a,name:"Unknown error",lineNumber:"Not available",fileName:d,stack:"Not available"};else{var g=!1;try{var h=a.lineNumber||a.line||"Not available"}catch(M){h="Not available",g=!0}try{var k=
a.fileName||a.filename||a.sourceURL||p.$googDebugFname||d}catch(M){k="Not available",g=!0}a=!g&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:k,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(c)||(h=h+":"+c);if(!(Ye[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){k=e;h={bb:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),
...
uf.prototype.m=function(){window.clearInterval(this.H);tf(this.D)};var vf={};function wf(){if(null==v("_lact",window)){var a=parseInt(Q("LACT"),10);a=isFinite(a)?z()-Math.max(a,0):-1;t("_lact",a,window);t("_fact",a,window);-1==a&&xf();V(document,"keydown",xf);V(document,"keyup",xf);V(document,"mousedown",xf);V(document,"mouseup",xf);V(window,"resize",function(){yf("resize",200)});
V(window,"scroll",function(){yf("scroll",200)});
...
function Jf(){ee(Ef);if(!Ya(W)){for(var a in W){var b=Df[a];if(b){var c=void 0,d=a,e=b,f=Bf[d],g=Gf[d]||{};Gf[d]=g;b=Math.round(O());for(c in W[d]){var h=e.b;h={client:{hl:h.Ha,gl:h.Ga,clientName:h.Fa,clientVersion:h.innertubeContextClientVersion}};var k=window.devicePixelRatio;k&&1!=k&&(h.client.screenDensityFloat=String(k));Q("DELEGATED_SESSION_ID")&&(h.user={onBehalfOfUser:Q("DELEGATED_SESSION_ID")});h={context:h};h[f]=If(d,c);g.dispatchedEventCount=g.dispatchedEventCount||0;g.dispatchedEventCount+=
...
function Pf(a){var b={"X-Goog-Visitor-Id":Q("VISITOR_DATA","")},c;a?c="Bearer "+v("gapi.auth.getToken")().cb:c=$b([]);c&&(b.Authorization=c,b["X-Goog-AuthUser"]=Q("SESSION_INDEX",0));return b}
function Qf(a){a=Object.assign({},a);delete a.Authorization;var b=$b();if(b){var c=new rc;c.update(Q("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();if(!oc)for(oc={},pc={},c=0;65>c;c++)oc[c]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c),pc[c]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(c);c=pc;for(var d=[],e=0;e<b.length;e+=3){var f=b[e],g=e+1<b.length,h=g?b[e+1]:0,k=e+2<b.length,m=k?b[e+2]:0,u=f>>2;f=(f&3)<<4|h>>4;h=(h&15)<<2|m>>
...
dg();if(h){var h=parseInt(h,10);isFinite(h)&&0<h&&(d="ST-"+Oa(d).toString(36),b=b?Jd(b):"",Rf(d,b,h||5))}else h="ST-"+Oa(d).toString(36),b=b?Jd(b):"",Rf(h,b,5)}}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var u=void 0===u?window:u;c=u.location;a=Kd(a,k)+m;a=a instanceof E?a:wb(a);c.href=ub(a)}return!0}
...
;function ig(a){a=a||{};this.url=a.url||"";this.args=a.args||$a(jg);this.assets=a.assets||{};this.attrs=a.attrs||$a(kg);this.params=a.params||$a(lg);this.minVersion=a.min_version||"8.0.0";this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
var jg={enablejsapi:1},kg={},lg={allowscriptaccess:"always",allowfullscreen:"true",bgcolor:"#000000"};function mg(a){var b=new ig,c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];b[c]="object"==oa(d)?$a(d):d}return b}
...
function qg(a){var b=rg(a),c=document.getElementById(b),d=c&&ce(c,"loaded");d||c&&!d||(c=sg(a,b,function(){ce(c,"loaded")||(ae(c),me(b),U(y(ne,b),0))}))}
...
function rg(a){var b=document.createElement("A");a=xb(a);Bb(b,a);b=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Oa(b)}
;var tg=v("ytLoggingLatencyUsageStats_")||{};t("ytLoggingLatencyUsageStats_",tg,void 0);var ug=0;function vg(a){tg[a]=tg[a]||{count:0};var b=tg[a];b.count++;b.time=O();ug||(ug=df(wg,5E3));return 10<b.count?(11==b.count&&$e(Error("CSI data exceeded logging limit with key: "+a),0==a.indexOf("info")?"WARNING":"ERROR"),!0):!1}
...
;var X=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};function Bg(){var a=Q("TIMING_TICK_EXPIRATION");a||(a={},P("TIMING_TICK_EXPIRATION",a));return a}
function Cg(){var a=Bg(),b;for(b in a)hf(a[b]);P("TIMING_TICK_EXPIRATION",{})}
...
st:"serverTimeMs",vph:"viewportHeight",vpw:"viewportWidth",yt_vis:"isVisible"},Lg="ap c cver ei srt yt_fss yt_li plid vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),Mg="isNavigation isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber isVisible watchInfo.isPlaylist".split(" "),
Ng=!1;
function Og(a){if("_"!=a[0]){var b=a;X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b))}b=Pg();var c=O();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;b=Bg();if(c=b[a])hf(c),b[a]=0;Qg()["tick_"+a]=void 0;O();Rg()?(b=Sg(),"_start"==a?vg("baseline_"+b)||Mf("latencyActionBaselined",{clientActionNonce:b},void 0,void 0):vg("tick_"+a+"_"+b)||Mf("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0,void 0),a=!0):a=!1;if(a=!a)a=!v("yt.timing.pingSent_");if(a&&(b=Yd("TIMING_ACTION"),a=
...
function Vg(){var a=Wg().info.yt_lt="hot_bg";Qg().info_yt_lt=a;if(Rg())if("yt_lt"in Ig){var b=Ig.yt_lt;0<=xa(Mg,b)&&(a=!!a);if(Rg()){var c={};b=b.split(".");for(var d=c,e=0;e<b.length-1;e++)d[b[e]]=d[b[e]]||{},d=d[b[e]];d[b[b.length-1]]=a;a=Sg();b=Object.keys(c).join("");vg("info_"+b+"_"+a)||(c.clientActionNonce=a,Mf("latencyActionInfo",c,void 0,void 0))}}else 0<=xa(Lg,"yt_lt")||R(Error("Unknown label yt_lt logged with GEL CSI."))}
...
function Ug(){Cg();if(!Rg()){var a=Pg(),b=Wg().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&w(a[d])){var e=d.slice(1);if(e in Hg){var f=za(a[d],function(a){return Math.round(a-c)});
b["all_"+e]=f.join()}delete a[d]}e=!!b.ap;if(f=v("ytglobal.timingReportbuilder_")){if(f=f(a,b,void 0))Xg(f,e),Yg(),Zg(),$g(!1,void 0),Q("TIMING_ACTION")&&P("PREVIOUS_ACTION",Q("TIMING_ACTION")),P("TIMING_ACTION","")}else{var g=Q("CSI_SERVICE_NAME","youtube");f={v:2,s:g,action:Q("TIMING_ACTION",void 0)};var h=b.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var k=window.location.protocol+v("ytplayer.config.assets.js");(k=X.getEntriesByName?X.getEntriesByName(k)[0]:null)?b.h5jse=Math.round(b.h5jse-k.responseEnd):
...
var Zg=x(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||ma,X);
function Xg(a,b,c){if(S("debug_csi_data")){var d=v("yt.timing.csiData");d||(d=[],t("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var f=void 0===f?"":f;try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,f)||We(a,void 0,void 0,void 0,f)}catch(g){We(a,void 0,void 0,void 0,f)}}else We(a);$g(!0,c)}
...
;function bh(a,b){G.call(this);this.l=this.T=a;this.H=b;this.o=!1;this.f={};this.R=this.G=null;this.w=new I;tc(this,y(uc,this.w));this.i={};this.O=this.S=this.g=this.Y=this.b=null;this.N=!1;this.j=this.D=null;this.U={};this.ua=["onReady"];this.X=null;this.ka=NaN;this.P={};ch(this);this.V("WATCH_LATER_VIDEO_ADDED",this.La.bind(this));this.V("WATCH_LATER_VIDEO_REMOVED",this.Ma.bind(this));this.V("onAdAnnounce",this.ya.bind(this));this.va=new ng(this);tc(this,y(uc,this.va))}
n(bh,G);l=bh.prototype;
l.ha=function(a){if(!this.h){a instanceof ig||(a=new ig(a));this.Y=a;this.b=mg(a);this.g=this.b.attrs.id||this.g;"video-player"==this.g&&(this.g=this.H,this.b.attrs.id=this.H);this.l.id==this.g&&(this.g+="-player",this.b.attrs.id=this.g);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.H;this.S||(this.S=dh(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.l.style.width=Sb(Number(a)||a);if(a=this.b.attrs.height)this.l.style.height=Sb(Number(a)||
...
function gh(a){var b=!0,c=hh(a);c&&a.b&&(a=a.b,b=ce(c,"version")==a.assets.js);return b&&!!v("yt.player.Application.create")}
...
a.N=!0;b?a.D():(re(a.b.assets.js,a.D),pg(a.b.assets.css),kh(a)&&!c&&t("yt.player.Application.create",null,void 0))}}}
function hh(a){var b=Gb(a.g);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.g));return b}
function ih(a){if(!a.h){var b=hh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.N=!1,b.isNotServable&&b.isNotServable(a.b.args.video_id)||lh(a)):a.ka=U(function(){ih(a)},50)}}
...
function ch(a){a.o=!1;if(a.R)for(var b in a.i)a.R(b,a.i[b]);for(var c in a.P)ee(parseInt(c,10));a.P={};a.G=null;a.R=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=a.V.bind(a);a.f.removeEventListener=a.Sa.bind(a);a.f.destroy=a.dispose.bind(a);a.f.getLastError=a.Ca.bind(a);a.f.getPlayerType=a.Da.bind(a);a.f.getCurrentVideoConfig=a.Ba.bind(a);a.f.loadNewVideoConfig=a.ha.bind(a);a.f.isReady=a.Ka.bind(a)}
l.Ka=function(){return this.o};
l.V=function(a,b){var c=this,d=dh(this,b);if(d){if(!(0<=xa(this.ua,a)||this.i[a])){var e=nh(this,a);this.G&&this.G(a,e)}this.w.subscribe(a,d);"onReady"==a&&this.o&&U(function(){d(c.f)},0)}};
l.Sa=function(a,b){if(!this.h){var c=dh(this,b);c&&ld(this.w,a,c)}};
...
function nh(a,b){var c="ytPlayer"+b+a.H;a.i[b]=c;p[c]=function(c){var d=a.b&&a.b.args&&a.b.args.fflags;if(d&&0>d.indexOf("use_html5_player_event_timeout=true"))a.w.J(b,c);else{var f=U(function(){if(!a.h){a.w.J(b,c);var d=a.P,e=String(f);e in d&&delete d[e]}},0);
Za(a.P,String(f))}};
return c}
l.ya=function(a){me("a11y-announce",a)};
l.La=function(a){me("WATCH_LATER_VIDEO_ADDED",a)};
l.Ma=function(a){me("WATCH_LATER_VIDEO_REMOVED",a)};
...
l.cancel=function(){this.D&&xe(this.b.assets.js,this.D);ee(this.ka);this.N=!1};
l.m=function(){jh(this);if(this.j&&this.b&&this.j.destroy)try{this.j.destroy()}catch(b){R(b)}this.U=null;for(var a in this.i)p[this.i[a]]=null;this.Y=this.b=this.f=null;delete this.T;delete this.l;G.prototype.m.call(this)};
function kh(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var oh={},ph="player_uid_"+(1E9*Math.random()>>>0);function qh(a){var b="player";b=r(b)?Gb(b):b;var c=ph+"_"+(b[sa]||(b[sa]=++ta)),d=oh[c];if(d)return d.ha(a),d.f;d=new bh(b,c);oh[c]=d;me("player-added",d.f);tc(d,y(rh,d));U(function(){d.ha(a)},0);
return d.f}
...
var uh=Mb(function(){var a=new wd;return a.isAvailable()?new sd(a):null}),th=Mb(function(){var a=new xd;
return a.isAvailable()?new sd(a):null});function vh(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
...
function xh(a,b,c){if(ra(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function yh(a,b,c,d){if(ra(a)&&!w(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};r(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
...
l.m=function(){var a=this.b;a.h||ld(a.b,"command",this.ra,this);this.b=null;for(var b in this.f)Ch(this,b);Ah.u.m.call(this)};function Fh(a,b){Ah.call(this,b);this.g=a;this.start()}
...
Gh.prototype.sendMessage=function(a,b){var c=b||this.f;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=Ic(a);c.postMessage(d,this.o)}catch(e){R(e,"WARNING")}}};
...
this))}
A(Lh,Ih);l=Lh.prototype;l.ta=function(a,b,c){if(this.b[a]){b=b||[];if(0<b.length&&vh(a)){var d=b;if(ra(d[0])&&!w(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=xh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=wh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=yh.apply(window,d)}d=e}zh(d);b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);vh(a)&&Kh(this,this.ca())}};
...
l.dispose=function(){Lh.u.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.b.removeEventListener(b.eventType,b.listener)}this.h=[]};function Mh(){G.call(this);this.b=new I;tc(this,y(uc,this.b))}
...
A(Nh,Mh);function Bh(a,b,c){if(!a.h){var d=a.f;d.h||a.g!=d.b||(a={id:a.i,command:b},c&&(a.data=c),d.b.postMessage(Ic(a),d.g))}}
Nh.prototype.m=function(){this.g=this.f=null;Nh.u.m.call(this)};function Oh(a,b,c){G.call(this);this.b=a;this.g=c;this.i=V(window,"message",x(this.j,this));this.f=new Nh(this,a,b);tc(this,y(uc,this.f))}
...
Oh.prototype.m=function(){tf(this.i);this.b=null;Oh.u.m.call(this)};function Ph(){var a=Va(window,"settings","experiments","flags","html5_serverside_pagead_id_sets_cookie")||Q("EXP_HTML5_SERVERSIDE_PAGEAD_ID_SETS_COOKIE",!1)||S("html5_serverside_pagead_id_sets_cookie")?"//googleads.g.doubleclick.net/pagead/id?exp=nomnom":"//googleads.g.doubleclick.net/pagead/id",b=$a(Qh),c;return bd(new H(function(d,e){b.A=function(a){Fe(a)?d(a):e(new Rh("Request failed, status="+a.status,"net.badstatus",a))};
b.onError=function(a){e(new Rh("Unknown request error","net.unknown",a))};
b.M=function(a){e(new Rh("Request timed out","net.timeout",a))};
c=Ne(a,b)}),function(a){a instanceof cd&&c.abort();
return Uc(a)})}
...
Sh.prototype.then=function(a,b,c){return this.h?this.h.then(a,b,c):1===this.f&&a?(a=a.call(c,this.b),Pc(a)?a:Th(a)):2===this.f&&b?(a=b.call(c,this.b),Pc(a)?a:Uh(a)):this};
Sh.prototype.getValue=function(){return this.b};
Oc(Sh);function Uh(a){var b=new Sh;a=void 0===a?null:a;b.f=2;b.b=void 0===a?null:a;return b}
function Th(a){var b=new Sh;a=void 0===a?null:a;b.f=1;b.b=void 0===a?null:a;return b}
;function Vh(a){B.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Wh;this.isTimeout=a instanceof Rh&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof cd}
n(Vh,B);Vh.prototype.name="BiscottiError";function Wh(){B.call(this,"Biscotti ID is missing from server")}
n(Wh,B);Wh.prototype.name="BiscottiMissingError";var Qh={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Xh=null;function Yh(){if("1"===Va(Zd(),"args","privembed"))return Uc(Error("Biscotti ID is not available in private embed mode"));Xh||(Xh=bd(Ph().then(Zh),function(a){return $h(2,a)}));
return Xh}
...
function bi(a,b){U(function(){bd(Ph().then(Zh,function(a){return $h(b,a)}),ma)},a)}
function ai(a){t("yt.ads.biscotti.lastId_",a,void 0)}
function ci(){try{var a=v("yt.ads.biscotti.getId_");return a?a():Yh()}catch(b){return Uc(b)}}
;function di(a){B.apply(this,arguments)}
n(di,B);di.prototype.name="YuzuError";function ei(){var a=new di("ID is missing"),b=new di("Timeout"),c=null,d=!1;Vd(function(){c=Td();d=!0});
if(d)return c?Th(c):Uh(a);var e=new H(function(b,c){Vd(function(){var d=Td();d?b(d):c(a)})}),f=Fd().then(function(){return Uc(b)});
return $c(Xc([e,f]),function(){return f.cancel()})}
;function fi(a){if("1"!==Va(Zd(),"args","privembed")){a&&(v("yt.ads.biscotti.getId_")||wa("yt.ads.biscotti.getId_",Yh));try{var b=ci();if(S("enable_yuzu")){v("yt.ads.yuzu.getId_")||t("yt.ads.yuzu.getId_",ei,void 0);try{var c=v("yt.ads.yuzu.getId_")()}catch(d){c=Uc(d)}}else c=Uc(new di("unimplemented"));Yc([b,c]).then(function(a){var b=a[0];a=a[1];if(b.Z||a.Z){b=b.value;a=a.value;var c={};c.dt=Tb;c.flash="0";a:{try{var d=window.top.location.href}catch(Ua){d=2;break a}d=null!=d?d==window.document.location.href?
...
F.navigator.mimeTypes.length);d.ca_type="image";if(S("enable_server_side_search_pyv")||S("enable_server_side_mweb_search_pyv")){k=window;try{var m=k.screenX;var u=k.screenY}catch(Ua){}try{var M=k.outerWidth;var Z=k.outerHeight}catch(Ua){}try{var Jg=k.innerWidth;var Kg=k.innerHeight}catch(Ua){}m=[k.screenLeft,k.screenTop,m,u,k.screen?k.screen.availWidth:void 0,k.screen?k.screen.availTop:void 0,M,Z,Jg,Kg];u=window.top;try{var T=(u||window).document,Ta="CSS1Compat"==T.compatMode?T.documentElement:T.body;
var Ga=(new Fb(Ta.clientWidth,Ta.clientHeight)).round()}catch(Ua){Ga=new Fb(-12245933,-12245933)}T={};Ta=0;p.SVGElement&&p.document.createElementNS&&(Ta|=1);T.bc=Ta;T.bih=Ga.height;T.biw=Ga.width;T.brdim=m.join();Ga=(T.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Rb.visibilityState||Rb.webkitVisibilityState||Rb.mozVisibilityState||""]||0,T.wgl=!!F.WebGLRenderingContext,T);for(var Ld in Ga)d[Ld]=Ga[Ld]}void 0!==b&&(d.bid=b);void 0!==a&&(d.anid=a);d.bsq=gi++;Te("//www.youtube.com/ad_data_204",
{Ea:!1,B:d,withCredentials:!0})}});
U(fi,18E5)}catch(d){R(d)}}}
var gi=0;var Y=v("ytglobal.prefsUserPrefsPrefs_")||{};t("ytglobal.prefsUserPrefsPrefs_",Y,void 0);function hi(){this.b=Q("ALT_PREF_COOKIE_NAME","PREF");var a=Zb.get(""+this.b,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Y[d]=c.toString())}}}
l=hi.prototype;l.get=function(a,b){ii(a);ji(a);var c=void 0!==Y[a]?Y[a].toString():null;return null!=c?c:b?b:""};
l.set=function(a,b){ii(a);ji(a);if(null==b)throw Error("ExpectedNotNull");Y[a]=b.toString()};
l.remove=function(a){ii(a);ji(a);delete Y[a]};
...
function ki(a){a=void 0!==Y[a]?Y[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
na(hi);var li=null,mi=null,ni=null,oi={};function pi(a){Mf(a.payload_name,a.payload,void 0,void 0)}
...
a.addEventListener("onLogVeClicked",ti);a.addEventListener("onLogVesShown",ui);a.addEventListener("onReady",vi);b=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?ni=new Lh(a):Q("ENABLE_POST_API")&&r(b)&&r(c)&&(mi=new Oh(window.parent,b,c),ni=new Fh(a,mi.f));Q("BG_P")&&(Q("BG_I")||Q("BG_IU"))&&ze();lf()},void 0);
t("yt.www.watch.ads.restrictioncookie.spr",function(a){We(a+"mac_204?action_fcts=1");return!0},void 0);
var wi=$d(function(){Og("ol");var a=hi.getInstance(),b=!!((ki("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&xc(document.body,"exp-invert-logo"))if(c&&!xc(document.body,"inverted-hdpi")){var d=document.body;d.classList?d.classList.add("inverted-hdpi"):xc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")}else!c&&xc(document.body,"inverted-hdpi")&&yc();b!=c&&(b="f"+(Math.floor(119/31)+1),d=ki(b)||0,d=c?d|67108864:d&-67108865,
0==d?delete Y[b]:Y[b]=d.toString(16).toString(),a.save())}),xi=$d(function(){var a=li;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&(ye=null);a=0;for(var b=jf.length;a<b;a++)hf(jf[a]);jf.length=0;we("//static.doubleclick.net/instream/ad_status.js");kf=!1;P("DCLKSTAT",0);vc(ni,mi);if(a=li)a.removeEventListener("onScreenChanged",ri),a.removeEventListener("onLogClientVeCreated",qi),a.removeEventListener("onLogServerVeCreated",si),a.removeEventListener("onLogToGel",pi),a.removeEventListener("onLogVeClicked",ti),a.removeEventListener("onLogVesShown",ui),a.removeEventListener("onReady",
vi),a.destroy();oi={}});
window.addEventListener?(window.addEventListener("load",wi),window.addEventListener("unload",xi)):window.attachEvent&&(window.attachEvent("onload",wi),window.attachEvent("onunload",xi));wa("yt.abuse.botguardInitialized",v("yt.abuse.botguardInitialized")||Be);wa("yt.abuse.invokeBotguard",v("yt.abuse.invokeBotguard")||Ce);wa("yt.abuse.dclkstatus.checkDclkStatus",v("yt.abuse.dclkstatus.checkDclkStatus")||mf);wa("yt.player.exports.navigate",v("yt.player.exports.navigate")||fg);
